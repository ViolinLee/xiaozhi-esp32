...
### ⚡ 速度调节
NodeHexa 支持四档速度调节，可以灵活控制机器人的运动速度：

| 速度档位 | 等级 | 倍速 | 描述 |
|---------|------|------|------|
| **slowest** | 0 | 0.25x | 极慢速，适合精细操作 |
| **slow** | 1 | 0.33x | 慢速，适合平稳移动 |
| **medium** | 2 | 0.5x | 中速，默认速度 |
| **fast** | 3 | 1.0x | 快速，适合快速移动 |
...
NodeHexa 通过 MCP (Model Context Protocol) 工具实现语音控制，支持三类机器人控制：
...
### ⚡ 机器人速度调节
用户可以通过自然语言调节六足机器人的运动速度：

- **速度控制**: "慢一点" / "快一点" / "设置成最快速度" / "用中速移动"
- **速度档位**: 
  - "极慢速" / "最慢速度" → slowest (0.25倍速)
  - "慢速" → slow (0.33倍速)
  - "中速" / "正常速度" → medium (0.5倍速，默认)
  - "快速" / "全速" → fast (1.0倍速)
